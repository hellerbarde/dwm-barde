...
/* appearance */
static const char font[]            = "-*-terminus-medium-r-normal-*-12-*-*-*-*-*-iso10646-*";
...
static const char selbgcolor[]      = "#4161b7";
...
static const char* colors[NumColors][ColLast] = {
	...
	{ normbordercolor, selfgcolor,  selbgcolor  },  // warning
...
static const double shade           = 0.75;      /* opacity of unfocused clients */
...
static const Rule rules[] = {
	...
	{ "chrome",   NULL,       NULL,       0,            False,       -1,       -1 },
	{ "Navigator",  NULL,       NULL,       1 << 8,       False,       -1,       -1 },
//	{ "URxvt",    NULL,       NULL,       0,            False,       -1,       0.95  },
};

/* layout(s) */
static const float mfact      = 0.666; /* factor of master area size [0.05..0.95] */
